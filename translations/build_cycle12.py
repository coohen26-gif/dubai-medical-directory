...
- translations/fiches-2026-06-06-cycle12.json (résumé)
- translations/build_cycle12.py (script, traçabilité)
"""
import csv
import json
import re
...
OUT_SUMMARY = ROOT / "fiches-2026-06-06-cycle12.json"
...
def main():
    ...
    selected_licenses = ["00174955", "00150972", "00246724", "00210833", "00177345"]
    ...
    summary = {
        "_meta": {
            "schema_version": SCHEMA_VERSION,
            "generated_at": NOW,
            "generator": "build_cycle12.py",
            "cron": "ad25646f-4b17-4eb0-b148-0b7d037c7231",
            "cron_name": "Dubai - Traduction 5 Langues",
            "cycle": "2026-06-06 cycle 12/30min",
            "previous_cycle": "2026-06-06 cycle 11/30min (70 fiches cumul, 25 in per_lang)",
            "languages": LANGS,
    ...
    print(f"✅ Cycle 12 done: {len(fiches)} fiches × {len(LANGS)} langs = {len(fiches)*len(LANGS)} traductions")
